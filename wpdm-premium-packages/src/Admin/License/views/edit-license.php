                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <form method="post" action="" id="edit-license-form" onsubmit="WPDM.blockUI('#edit-license-form');">
                            ...
                            <div class="form-group">
                                ...
                                <input id="title" class="form-control input-lg" type="text" readonly="readonly" value="<?php echo esc_attr( $license->licenseno ); ?>">
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php _e('Order ID:', 'wpdm-premium-packages'); ?></label>
                                        <input class="form-control" type="text" readonly="readonly" value="<?php echo esc_attr( $license->oid ); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php _e('Product ID:', 'wpdm-premium-packages'); ?></label>
                                        <input class="form-control" type="text" readonly="readonly" value="<?php echo (int) $license->pid; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" min="0" step="1" name="license[domain_limit]"
                                               value="<?php echo (int) $license->domain_limit; ?>"/>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label>
                                    ...
                                    <span class="ttip" title="One domain per line. Don't use 'http://' or 'www' only 'domain.com'"><?php echo \WPDMPP\UI\Icons::get('info-circle', 16); ?></span></label>
                                <?php
                                ...
                                <textarea class="form-control" cols="60" rows="6"
                                          name="license[domain]"><?php echo esc_textarea( $license->domain ); ?></textarea>
                            ...
                            <div class="form-group well text-right">
                                <button class="btn btn-primary btn-lg"><?php echo \WPDMPP\UI\Icons::get('save', 16); ?> <?php _e('Update License', 'wpdm-premium-packages'); ?></button>
                            </div>
